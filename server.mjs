...
const COMPETITOR_REFERENCE_PRODUCTS = [
  {brand:'설화수',product:'윤조에센스 6세대',category:'안티에이징·퍼스트 에센스',known:'설화수 공식 자료에서 안티에이징 에센스로 소개되며, 인삼 연구와 E.G.R.3 TECHNOLOGY를 핵심으로 내세운다.',compareMaiim:'탄력·노화 고민에서는 마임 화장품 비에타 안티에이징 에센스 또는 비타 콜라겐 인텐시브 앰플과 목적을 비교할 수 있다. 마임 쪽은 공식 전성분에서 세라마이드NP·히알루론산·레티닐팔미테이트 또는 콜라겐·아데노신 등이 확인된다.'},
  {brand:'라네즈',product:'크림 스킨 세라펩타이드 리파이너',category:'첫 단계 보습·장벽',known:'라네즈 공식 자료에서 첫 단계부터 보습과 장벽, 속탄력 케어를 내세우는 베스트셀러로 소개된다.',compareMaiim:'건조·장벽 고민에서는 마임 화장품 라헬 나이트케어 보습젤과 비교할 수 있다. 라헬 나이트케어 보습젤은 세라마이드NP·판테놀·히알루론산·우레아·스쿠알란이 공식 전성분에서 확인된다.'},
  {brand:'이니스프리',product:'그린티 히알루론산 수분 세럼',category:'수분·진정 세럼',known:'이니스프리 공식 자료에서 히알루론산과 생녹차수를 중심으로 속건조 수분 공급과 진정 포지셔닝을 내세운다.',compareMaiim:'가벼운 수분·진정이 우선이면 마임 화장품 라헬 데이케어 수분젤과 비교할 수 있다. 라헬 데이케어 수분젤은 알로에·병풀·히알루론산·글루코노락톤 등이 공식 전성분에서 확인된다.'},
  {brand:'아토팜',product:'MLE 크림',category:'민감·건조 피부장벽',known:'아토팜 공식 자료에서 MLE® 피부장벽 기술과 민감·건조 피부의 장벽 관리에 초점을 둔다.',compareMaiim:'마임 화장품 라헬 나이트케어 보습젤과 같은 장벽·보습 목적 제품과 비교할 수 있다. 두 제품의 접근은 다르므로 피부 민감도, 제형 선호, 현재 자극 상태를 함께 본다.'},
  {brand:'닥터포헤어',product:'폴리젠 씨크닝 샴푸',category:'두피·탈모증상완화 샴푸',known:'닥터포헤어 공식몰에서 두피 타입별 전문 케어와 탈모증상완화 제품군의 대표 샴푸로 판매된다.',compareMaiim:'비듬·각질·가려움이 핵심이면 마임 화장품 라헬 헤어시스 샴푸 또는 비에타 헤어케어 에센스 샴푸와 비교할 수 있다. 마임 두 샴푸는 공식 전성분에서 살리실산과 클림바졸이 확인되어 각질·비듬 관리 관점의 설명이 가능하다.'},
  {brand:'려',product:'자양윤모 9EX 탈모증상전문케어 샴푸',category:'탈모증상전문케어·두피 타입별',known:'려 공식 자료에서 지성·중건성·민감성 두피용으로 나뉜 탈모증상전문케어 샴푸 라인을 운영한다.',compareMaiim:'탈모 증상 자체가 중심이면 려의 기능성 포지셔닝을 인정하고, 비듬·각질·세정·두피 불편감이 중심이면 마임 화장품 라헬 헤어시스 샴푸나 비에타 헤어케어 에센스 샴푸의 공식 전성분과 현재 증상을 기준으로 비교한다.'},
  {brand:'아모스프로페셔널',product:'녹차실감 샴푸',category:'살롱 전문 두피·탈모 케어',known:'아모스프로페셔널 공식 자료에서 지성·중건성·민감성 두피 타입별 녹차실감 샴푸 라인을 운영한다.',compareMaiim:'전문 두피케어라는 장점은 인정하되, 고객의 현재 비듬·각질·가려움과 마임 화장품 샴푸의 살리실산·클림바졸 포함 여부, 사용감과 자극 반응을 기준으로 공정하게 비교한다.'}
];

function competitorReferenceText(){
  return COMPETITOR_REFERENCE_PRODUCTS.map(x=>`- ${x.brand} ${x.product} [${x.category}]: ${x.known} 비교 포인트: ${x.compareMaiim}`).join('\n');
}
...
[타사 화장품 비교 상담 — 공정하고 자신 있게]
- 고객이 타사 브랜드나 제품을 묻거나 “마임 화장품과 비교해 주세요”라고 하면 회피하지 말고, 알고 있는 대표 제품은 구체적인 제품명까지 말하며 비교합니다.
- 비교 순서는 ① 타사 제품의 알려진 장점·주요 목적 인정 ② 고객의 현재 고민과 맞는 점/덜 맞는 점 ③ 마임 화장품에서 대응되는 제품 1개 또는 2개 ④ 마임 제품이 현재 고객에게 더 맞을 수 있는 구체적 이유 순서로 합니다.
- “그 제품도 좋은 제품입니다. 다만 지금 말씀하신 ○○ 고민을 기준으로 보면, 마임 화장품의 ○○는 △△ 성분/제형/관리목표가 더 직접적으로 연결됩니다.” 같은 화법을 사용할 수 있습니다.
...
- 위 대표 타사 제품 목록에 없는 제품을 물으면 존재·성분·효능을 꾸며내지 않습니다. 정확한 제품명을 확인하고, 현재 공식 전성분이 필요한 비교라면 “최신 전성분 확인이 필요합니다”라고 솔직히 말합니다.
