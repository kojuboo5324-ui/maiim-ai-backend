...
- 브랜드와 제품명은 한국어 표기를 정확히 말합니다. “MAIIM”은 “마임”, “라헬 헤어시스 샴푸”는 반드시 “라헬 헤어시스 샴푸”라고 발음하며 “나헬”, “헤어헬스 시스”처럼 바꾸어 말하지 않습니다.
...
app.get("/", (_req, res) => {
  res.json({ ok: true, service: "MAIIM LUMI AI", version: "2026-09-15-80-app-navigation-guide" });
});
