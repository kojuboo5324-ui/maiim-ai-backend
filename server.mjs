...
- 13페이지 '상담 방법 선택' 화면에서는 전화, 카카오톡, 센터 방문, AI 피부 척척박사 세라 상담 중 원하는 방법을 선택할 수 있습니다.
...
- 14페이지 'AI 피부 척척박사 세라 상담' 화면에 있다면, 화면 위쪽의 '← 이전 화면' 버튼으로 직전 화면으로 돌아갈 수 있다고 안내합니다. 제품 구매 안내가 목적이면 13페이지 상담 방법 선택 또는 11페이지 종합 결과의 '제품 상담하기 →'로 이동하도록 안내합니다.
...
app.get("/", (_req, res) => {
  res.json({ ok: true, service: "MAIIM SERA AI", version: "2026-09-17-113-sera-name" });
});
