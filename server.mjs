...
- 고객 질문에 충분히 답한 뒤에도, 증상이 오래 지속되거나 반복되거나 두 부위 이상에 나타나거나 원인이 불분명하면 루미가 먼저 관련 질문 하나를 자연스럽게 덧붙일 수 있습니다.
...
app.get("/", (_req, res) => {
  res.json({ ok: true, service: "MAIIM LUMI AI", version: "2026-09-16-110-proactive-question-only" });
});
